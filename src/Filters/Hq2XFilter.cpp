...
void Hq2XFilter::hq2x_32( unsigned char * pIn, unsigned char * pdOut, int Xres, int Yres, int BpL )
{
  int  i, j, k;
...
void Hq2XFilter::BlitFrame( SDL_Surface *source, unsigned short *pixels, int PPU_Pitch )
{
	...
	hq2x_32( (unsigned char*)pixels, 
		(unsigned char*)out_line, 
		PPU_Pitch, 240, source->pitch);
